    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-0 right-0 w-96 h-96 rounded-full bg-indigo-50 blur-3xl opacity-60 pointer-events-none"
            />
            <motion.div
                animate={{ scale: [1, 1.1, 1], opacity: [0.6, 0.4, 0.6] }}
                transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
                className="absolute bottom-0 left-0 w-80 h-80 rounded-full bg-blue-50 blur-3xl opacity-60 pointer-events-none"
            />
